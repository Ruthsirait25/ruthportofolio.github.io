// changin skill spam
let mySkills = ["frontend", "backend", "mobile Development"];
...
// progress bar
let progressHeader = document.querySelectorAll(".skills ul li .txt h3:last-child");
let progressBox = document.querySelectorAll(".skills .box");
document.onscroll = function () {
  progressBox.forEach(function (ele, index) {
    let progressBars = document.querySelectorAll(`.skills .box:nth-child(${index + 1})  .progress`);
